...
Before you run the script, in terminal run: sudo journalctl > journalctl.txt to pipe binary log to txt
Alternative, run: sudo journalctl -b > /path/to/your/home/journalctl.txt
"""
