...
Before you run the script, in terminal run: journalctl -b > journalctl.txt to pipe binary log to txt
Alternatively you can define path, run: journalctl -b > /path/to/your/home/journalctl.txt
"""
